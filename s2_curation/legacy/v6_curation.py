...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Create curated video with specified duration"
    )
    parser.add_argument(
        "--duration",
        type=int,
    ...
    try:
        ...
        # Find best segments
        print(
            f"Analyzing content and finding best segments for {target_duration}s video..."
        )
        best_segments = find_best_segments(
            words, target_duration=target_duration, min_segment_duration=5
        )
