...
class FaceTracker:
    ...
    def update(self, bbox, frame_shape):
        ...
        # Calculate crop width and height maintaining original aspect ratio
        ...
        # Calculate crop coordinates to center on the face
        crop_x1 = max(0, min(smoothed_x - crop_width // 2, original_width - crop_width))
        crop_y1 = max(
            0, min(smoothed_y - crop_height // 2, original_height - crop_height)
        )
...
def reframe_video_with_audio(input_path, output_path):
    """
    Reframe the video to 9:16 aspect ratio with face tracking and no resizing.
    """
    ...
    # Initialize video writer with original video codec and dimensions
